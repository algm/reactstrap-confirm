    ...
    const result = await confirm({
      ...
      message: (
        <Card>
          ...
          <CardBody>
            <CardText>
              You can customize the message using anything you want!
            </CardText>
          </CardBody>
        </Card>
      ),
...
export const Alert = () => {
  const alertDialog = async () => {
    await confirm({
      title: 'Warning!',
      message: 'You can use the confirm function as a way to display alerts!',
      cancelText: null,
  ...
  return (
    <Container class="py-3">
      <p>
        This module can also be used for displaying alerts if you pass the
        cancelText as null (that will hide the cancel action).
      </p>
...
export const customButtonsComponent = () => {
  ...
  return (
    <Container class="py-3">
      <p>
        You can pass a custom buttons component to customize the behavior even
        further!
      </p>
